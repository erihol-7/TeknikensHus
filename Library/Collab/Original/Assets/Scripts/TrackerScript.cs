...
public class TrackerScript : MonoBehaviour
{
    ...
    private void UpdateImage(ARTrackedImage trackedImage)
    {
        ...
        //var angle = new Quaternion(0,Vector3.SignedAngle(worldOrigin.transform.position - arCamera.transform.position, worldOrigin.transform.forward, worldOrigin.transform.up) + worldOrigin.transform.rotation.y,0,0);
